...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcApp_helpersAuthGuardTs(module, __webpack_exports__, __webpack_require__) {
    ...
    "./src/app/_services/authentication.service.ts"); //CanActivate interface which the guard to  decide if a route can be activated with the canActivate() method
    ...
    var FakeBackendInterceptor = /*#__PURE__*/function () {
      ...
      _createClass(FakeBackendInterceptor, [{
        ...
        value: function intercept(request, next) {
          ...
          function isLoggedIn() {
            return headers.get('Authorization') === "Basic ".concat(window.btoa('test:test'));
          }
        }
      }]);
  ...
  function srcApp_helpersFilterPipeTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    /*! @angular/core */
    "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js"); //custome pipe
  ...
  /***/
  function srcApp_helpersReplaceTimePipeTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ReplaceTimePipe", function () {
      return ReplaceTimePipe;
    });
    /* harmony import */
    ...
    var ReplaceTimePipe = /*#__PURE__*/function () {
      function ReplaceTimePipe() {
        _classCallCheck(this, ReplaceTimePipe);
      }

      _createClass(ReplaceTimePipe, [{
        key: "transform",
        value: function transform(unixTime, time) {
          ...
          time = date.toLocaleDateString(); //+ ' ' + hr + ':' + m.substr(-2) + ':' + s.substr(-2);
    ...
    ReplaceTimePipe.ɵfac = function ReplaceTimePipe_Factory(t) {
      return new (t || ReplaceTimePipe)();
    };

    ReplaceTimePipe.ɵpipe = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefinePipe"]({
      name: "replaceTime",
      type: ReplaceTimePipe,
      pure: true
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ReplaceTimePipe, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Pipe"],
        args: [{
          name: 'replaceTime'
        }]
  ...
  function srcApp_servicesAuthenticationServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! @angular/common/http */
    "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/http.js"); //RxJS Subjects and Observables are used to store the current user object and notify other components when the user logs in and out of the app
    ...
    var AuthenticationService = /*#__PURE__*/function () {
      function AuthenticationService(http) {
        ...
        this.http = http;
        this.currentUserSubject = new rxjs__WEBPACK_IMPORTED_MODULE_1__["BehaviorSubject"](JSON.parse(localStorage.getItem('currentUser'))); //allows other components to subscribe to the currentUser
      ...
      _createClass(AuthenticationService, [{
        ...
        value: function login(username, password) {
          ...
          return this.http.post("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].backend.authenticateURL, "/users/authenticate"), {
            username: username,
            password: password
          }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (user) {
            // store user details and basic auth credentials in local storage to keep user logged in between page refreshes
            user.authdata = window.btoa(username + ':' + password);
            localStorage.setItem('currentUser', JSON.stringify(user)); //The user object is then published to all subscribers with the call to below line
    ...
    var UserService = /*#__PURE__*/function () {
      ...
      _createClass(UserService, [{
        ...
        value: function getAll() {
          return this.http.get("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].backend.authenticateURL, "/users"));
        }
      }]);
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _helpers_basic_auth_interceptor__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ./_helpers/basic-auth.interceptor */
    "./src/app/_helpers/basic-auth.interceptor.ts");
    /* harmony import */
    ...
    var _helpers_replace_time_pipe__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ./_helpers/replace-time.pipe */
    "./src/app/_helpers/replace-time.pipe.ts");
    /* harmony import */


    var _helpers_filter_pipe__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      providers: [_services_data_service__WEBPACK_IMPORTED_MODULE_9__["DataService"], {
        ...
        useClass: _helpers_basic_auth_interceptor__WEBPACK_IMPORTED_MODULE_11__["BasicAuthInterceptor"],
        multi: true
      }, {
        provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HTTP_INTERCEPTORS"],
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_5__["AppComponent"], _helpers_filter_pipe__WEBPACK_IMPORTED_MODULE_14__["FilterPipe"], _home_home_component__WEBPACK_IMPORTED_MODULE_6__["HomeComponent"], _coding_coding_component__WEBPACK_IMPORTED_MODULE_7__["CodingComponent"], _login_login_component__WEBPACK_IMPORTED_MODULE_8__["LoginComponent"], _helpers_replace_time_pipe__WEBPACK_IMPORTED_MODULE_13__["ReplaceTimePipe"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_4__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  function srcAppCodingCodingComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _helpers_replace_time_pipe__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../_helpers/replace-time.pipe */
    "./src/app/_helpers/replace-time.pipe.ts");

    function CodingComponent_li_27_ng_template_1_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        var article_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
    ...
    function CodingComponent_li_27_ng_template_2_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function CodingComponent_li_27_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CodingComponent_ul_30_li_1_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "li");
    ...
    function CodingComponent_ul_30_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CodingComponent_ng_template_45_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CodingComponent_ng_template_46_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "p");
    ...
    function CodingComponent_p_51_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "p");
    ...
    function CodingComponent_table_52_tr_12_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CodingComponent_table_52_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CodingComponent_p_56_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "p");
    ...
    function CodingComponent_table_57_tr_8_ng_template_1_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        var job_r20 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
    ...
    function CodingComponent_table_57_tr_8_ng_template_2_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "td");
    ...
    function CodingComponent_table_57_tr_8_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "tr");
    ...
    function CodingComponent_table_57_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "table", 34);
    ...
    var CodingComponent = /*#__PURE__*/function () {
      ...
      _createClass(CodingComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this._data.getWeather().subscribe(function (data) {
            _this4.forecasts = data;
          });

          this._data.getBeer().subscribe(function (data) {
            _this4.brews = data; //console.log(this.brews);
          });
        ...
        value: function getTopStories() {
          ...
          this._data.getArticleIds().subscribe(function (res) {
            _this5.articlesIds = res;

            var item = _this5.articlesIds.slice(Math.max(_this5.articlesIds.length - _this5.newsCount, 0)).map(function (i) {
              _this5._data.getArticleDetail(i).subscribe(function (res) {
                _this5.article = res;

                _this5.articles.push(_this5.article);

                _this5._articlesLocal.push(_this5.article);

                localStorage[CACHE_KEY] = JSON.stringify(_this5._articlesLocal);
              });
            });
          });
        } //search box
    ...
    CodingComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function CodingComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function CodingComponent_Template_input_ngModelChange_25_listener($event) {
            return ctx.searchStr = $event;
          })("ngModelChange", function CodingComponent_Template_input_ngModelChange_25_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CodingComponent_Template_span_click_35_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function CodingComponent_Template_input_ngModelChange_39_listener($event) {
      ...
      pipes: [_helpers_filter_pipe__WEBPACK_IMPORTED_MODULE_4__["FilterPipe"], _angular_common__WEBPACK_IMPORTED_MODULE_3__["UpperCasePipe"], _helpers_replace_time_pipe__WEBPACK_IMPORTED_MODULE_5__["ReplaceTimePipe"]],
  ...
  function srcAppHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function HomeComponent_ul_7_li_1_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "li");
    ...
    HomeComponent.ɵfac = function HomeComponent_Factory(t) {
      return new (t || HomeComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"]));
    };
    ...
    HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 8,
      vars: 2,
      consts: [[1, "card", "mt-4"], [1, "card-header"], [1, "card-body"], ["class", "spinner-border spinner-border-sm", 4, "ngIf"], [4, "ngIf"], [1, "spinner-border", "spinner-border-sm"], [4, "ngFor", "ngForOf"]],
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\prett\source\repos\AngularAPI\Angular\patApp\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
